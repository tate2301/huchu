...
export async function GET(request: NextRequest) {
  try {
    ...
    return successResponse(paginationResponse(customers, total, page, limit));
  } catch (error) {
    console.error("[API] GET /api/accounting/sales/customers error:", error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("[API] POST /api/accounting/sales/customers error:", error);
