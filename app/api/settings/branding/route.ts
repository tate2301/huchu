...
const updateBrandingSchema = z
  .object({
    ...
    privacyPolicyUrl: z.string().trim().url().max(500).nullable().optional(),
    ...
    bankBranchCode: z.string().trim().max(60).nullable().optional(),
  ...
  try {
    ...
    await prisma.companyBranding.upsert({
      ...
      update: {
        ...
        ...(validated.privacyPolicyUrl !== undefined ? { privacyPolicyUrl: validated.privacyPolicyUrl } : {}),
        ...(validated.termsUrl !== undefined ? { termsUrl: validated.termsUrl } : {}),
        ...(validated.bankName !== undefined ? { bankName: validated.bankName } : {}),
        ...(validated.bankBranch !== undefined ? { bankBranch: validated.bankBranch } : {}),
        ...(validated.bankBranchCode !== undefined ? { bankBranchCode: validated.bankBranchCode } : {}),
        ...(validated.bankAddress !== undefined ? { bankAddress: validated.bankAddress } : {}),
      ...
      create: {
        ...
        privacyPolicyUrl: validated.privacyPolicyUrl ?? null,
        termsUrl: validated.termsUrl ?? null,
        bankName: validated.bankName ?? null,
        bankBranch: validated.bankBranch ?? null,
        bankBranchCode: validated.bankBranchCode ?? null,
