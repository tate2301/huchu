...
function mapGoldSettings(
  ...
  return {
    ...
    autoGenerateGoldPayoutPeriods: String(
      config.autoGenerateGoldPayoutPeriods,
    ) as "true" | "false",
...
export default function GoldPayrollPage() {
  ...
  const expandedRunsQueries = useQueries({
    queries: expandedPeriodIds.map((periodId) => ({
      ...
      queryFn: () =>
        fetchPayrollRuns({ domain: "GOLD_PAYOUT", periodId, limit: 200 }),
      staleTime: 30_000,
    })),
  });
    ...
    mutationFn: async (payload: GoldSettingsForm) =>
      updatePayrollConfig({
        ...
        autoGenerateGoldPayoutPeriods:
          payload.autoGenerateGoldPayoutPeriods === "true",
  ...
  const runDetailColumns = useMemo<ColumnDef<RunDetailLine>[]>(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <NumericCell>{row.original.variableAmount.toFixed(2)}</NumericCell>
        ),
        size: 160,
        minSize: 160,
        maxSize: 160,
          ...
          {configLoading || !settingsForm ? (
            ...
            >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setSettingsOverrides((prev) => ({
                      ...prev,
                      goldPayoutCycle:
                        value as GoldSettingsForm["goldPayoutCycle"],
                    }))
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  value={settingsForm.goldSettlementMode}
                  onValueChange={(value) =>
                    setSettingsOverrides((prev) => ({
                      ...prev,
                      goldSettlementMode:
                        value as GoldSettingsForm["goldSettlementMode"],
                    }))
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    <SelectItem value="CURRENT_PERIOD">
                      Current period
                    </SelectItem>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setSettingsOverrides((prev) => ({
                      ...prev,
                      autoGenerateGoldPayoutPeriods:
                        value as GoldSettingsForm["autoGenerateGoldPayoutPeriods"],
                    }))
                  }
                >
                  <SelectTrigger>
      ...
      >
        <DialogContent size="xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Detailed employee line amounts for this run.
            </DialogDescription>
          </DialogHeader>
          {runDetailsLoading ? (
            <Skeleton className="h-24 w-full" />
            ...
            <div className="space-y-3">
              <div className="grid gap-3 sm:grid-cols-4 text-sm">
                ...
                <div className="rounded-md border-0 p-2 shadow-[var(--surface-frame-shadow)]">
                  ...
                  <div className="font-semibold">Per-allocation snapshot</div>
                </div>
              </div>
