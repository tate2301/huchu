...
export default function StoresMovementsReportPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["stock-movements", "reports", activeSiteId ?? "all", movementType],
    queryFn: () =>
      fetchStockMovements({
        siteId: activeSiteId,
    ...
    <div className="mx-auto w-full max-w-6xl space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filter by site, type, date, and search text</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{filteredRows.length} movement records</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
