...
export default function GoldDispatchCreatePage() {
  ...
  return (
    <GoldShell
      activeTab="dispatch"
      description="Generate a chain-of-custody dispatch manifest"
      actions={
        <Button asChild variant="outline" size="sm">
          <Link href="/gold/dispatch">View Dispatch History</Link>
        </Button>
      }
    >
