...
// The People host is one workspace package. The repository root is where the lockfile,
...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@corelithzw/db", "@corelithzw/ui", "@corelithzw/platform", "@corelithzw/shell", "@corelithzw/module-workflow", "@corelithzw/module-notifications", "@corelithzw/module-offline", "@corelithzw/module-records", "@corelithzw/module-documents", "@corelithzw/module-books", "@corelithzw/module-people", "@corelithzw/module-compliance"],
  experimental: {
