...
import { PEOPLE_TABS, PEOPLE_CATEGORIES } from "@corelithzw/module-people/people/tab-config";
import { PAYROLL_TABS, PAYROLL_CATEGORIES } from "@corelithzw/module-people/payroll/tab-config";
