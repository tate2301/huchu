...
const { POST: postReceipt } = await import("@corelithzw/module-campus/api/v2/schools/fees/receipts/route");
const { GET: getFiscal, POST: postFiscal } = await import(
  "@corelithzw/module-campus/api/v2/schools/fees/receipts/[id]/fiscalise/route"
);
