...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@corelithzw/db", "@corelithzw/ui", "@corelithzw/platform", "@corelithzw/shell", "@corelithzw/module-workflow", "@corelithzw/module-notifications", "@corelithzw/module-records", "@corelithzw/module-documents", "@corelithzw/module-books", "@corelithzw/module-people"],
  experimental: {
