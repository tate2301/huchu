...
echo "== enterprise build"; (pnpm turbo run build --filter=@corelithzw/enterprise > /tmp/claude-0/-home-user-huchu/eafc178b-2c3f-5a7f-bcbb-c8e593fa6116/scratchpad/build-5c.log 2>&1); echo "BUILD_EXIT=$?"
echo "ALL_DONE"
