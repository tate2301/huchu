...
- Dashboards and exports for collections, arrears, enrollment, and occupancy run without errors.
...
- Dashboards surface pipeline/margin/payment/delivery metrics; exports complete successfully.
...
- Shift close outputs variance report; dashboards and exports for sales, margin, promo lift, shrinkage, and on-hand succeed.
...
- Reconciliation job highlights variances with exports and tracked resolutions; manual edits to posting-managed accounts require approval.
