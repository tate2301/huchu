...
| 2026-02-27 | `feat/schools-portals-phase2-v1` | Wave 1 Schools portals + module UI/API activation (increment 2) | Completed | Real `/api/v2/portal/*` payloads, `/api/v2/schools/portal/*` aliases, schools dashboard/boarding/results data views, and portal table UX aligned with playbook. PR: #34 |
| 2026-02-27 | `feat/schools-fees-phase3-v1` | Wave 1 Schools fees lifecycle + portal finance visibility (increment 3) | Completed | Fee structures/invoices/receipts/waivers/write-off APIs, schools fees UI, parent/student portal fee tabs, child fee-visibility guard, accounting integration events and sequencing updates. PR: #35 |
| 2026-02-27 | `feat/schools-governance-phase4-v1` | Wave 1 Schools governance + publish-window hardening (increment 4) | Completed | Teacher profile/subject/class-assignment models and APIs, publish-window governance APIs, moderation audit actions, assignment-scoped teacher portal, parent/student scope hardening, results publish-window UI and dashboard governance metrics. PR: #36 |
| 2026-02-27 | `feat/car-sales-core-phase1-v1` | Wave 2 Car sales core foundation (increment 1) | Completed | Core car-sales domain models (lead/vehicle/deal/payment), autos/car-sales v2 APIs, reserve/contract/payment transitions, ID sequences, and `/car-sales` operational data views. PR: #37 |
| 2026-02-27 | `feat/schools-car-sales-depth-phase5-v1` | Wave 1/2 depth hardening (increment 5) | Completed | Real route-level car-sales pages (leads/inventory/deals/financing), schools students/admissions/attendance/teachers pages, boarding leave/check-in/check-out lifecycle APIs + movement logs, portal attendance/notices surfaces, and schools teacher feature-gating/navigation hardening. |
