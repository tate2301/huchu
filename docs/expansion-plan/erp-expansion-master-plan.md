...
| 2026-02-27 | `feat/schools-governance-phase4-v1` | Wave 1 Schools governance + publish-window hardening (increment 4) | In Progress | Teacher profile/subject/class-assignment models and APIs, publish-window governance APIs, moderation audit actions, assignment-scoped teacher portal, parent/student scope hardening, results publish-window UI and dashboard governance metrics. |
