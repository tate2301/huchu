...
| 2026-02-27 | `feat/schools-fees-phase3-v1` | Wave 1 Schools fees lifecycle + portal finance visibility (increment 3) | In Progress | Fee structures/invoices/receipts/waivers/write-off APIs, schools fees UI, parent/student portal fee tabs, child fee-visibility guard, accounting integration events and sequencing updates. |
