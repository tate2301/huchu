...
| 2026-02-27 | `feat/car-sales-core-phase1-v1` | Wave 2 Car sales core foundation (increment 1) | In Progress | Core car-sales domain models (lead/vehicle/deal/payment), autos/car-sales v2 APIs, reserve/contract/payment transitions, ID sequences, and `/car-sales` operational data views. |
