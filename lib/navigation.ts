...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/schools/results", icon: FileCheck, label: "Results" },
      { href: "/schools/fees", icon: ReceiptLong, label: "Fees" },
  ...
  },
  {
    id: "car-sales",
    title: "Car Sales",
    description: "Vehicle sales and lead management",
    items: [
      { href: "/car-sales", icon: LocalShipping, label: "Dashboard" },
  ...
  },
  {
    id: "thrift",
    title: "Thrift Store",
    description: "Thrift store operations and POS",
    items: [
      { href: "/thrift", icon: Wallet, label: "Dashboard" },
