...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/schools/attendance", icon: UserCheck, label: "Schools Attendance" },
      { href: "/schools/boarding", icon: Home, label: "Schools Boarding" },
      { href: "/schools/teachers", icon: ManageAccounts, label: "Teacher Management" },
      { href: "/schools/results", icon: FileCheck, label: "Schools Results" },
      { href: "/schools/fees", icon: ReceiptLong, label: "School Fees" },
      { href: "/car-sales", icon: LocalShipping, label: "Car Sales" },
      { href: "/car-sales/leads", icon: Users, label: "Car Leads" },
      { href: "/car-sales/inventory", icon: Package, label: "Car Inventory" },
      { href: "/car-sales/deals", icon: Checklist, label: "Car Deals" },
      { href: "/car-sales/financing", icon: Wallet, label: "Car Financing" },
