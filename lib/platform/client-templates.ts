...
export const CLIENT_BUNDLE_TEMPLATES: ClientBundleTemplateDefinition[] = [
  ...
  },
  {
    ...
    description: "Retail pack with catalog, POS, inventory accuracy, purchasing, promotions, and cash-up.",
    targetClients: ["Retailers", "Stores", "Omnichannel merchants"],
    recommendedTierCode: "BASIC",
    bundleCodes: ["ADDON_RETAIL_SUITE"],
    featureKeys: [],
    disabledFeatureKeys: ["schools.core", "autos.core", "thrift.core", "portal.schools", "portal.autos", "portal.car-sales", "portal.thrift"],
  },
  {
