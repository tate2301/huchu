...
export const FEATURE_CATALOG: FeatureCatalogEntry[] = [
  ...
  f({ key: "stores.fuel-ledger", name: "Fuel Ledger", description: "Fuel-related stock and reporting.", domain: "stores", defaultEnabled: false, isBillable: true, monthlyPrice: 12 }),
  ...
  f({ key: "maintenance.equipment", name: "Equipment Register", description: "Equipment lifecycle and maintenance meta.", domain: "maintenance", defaultEnabled: false, isBillable: true, monthlyPrice: 12 }),
  f({ key: "maintenance.work-orders", name: "Work Orders", description: "Work order operations and workflows.", domain: "maintenance", defaultEnabled: false, isBillable: true, monthlyPrice: 12 }),
  f({ key: "maintenance.breakdowns", name: "Breakdown Tracking", description: "Breakdown logging and remediation.", domain: "maintenance", defaultEnabled: false, isBillable: true, monthlyPrice: 8 }),
  f({ key: "maintenance.schedule", name: "Maintenance Schedule", description: "Planned maintenance schedule.", domain: "maintenance", defaultEnabled: false, isBillable: true, monthlyPrice: 8 }),
  ...
  f({ key: "reports.fuel-ledger", name: "Fuel Ledger Reports", description: "Fuel ledger reports.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 6 }),
  f({ key: "reports.maintenance-work-orders", name: "Maintenance Work Order Reports", description: "Work order reporting.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 6 }),
  f({ key: "reports.maintenance-equipment", name: "Maintenance Equipment Reports", description: "Equipment performance reporting.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 6 }),
  f({ key: "reports.gold-chain", name: "Gold Chain Reports", description: "Gold chain reporting.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 8 }),
  f({ key: "reports.gold-receipts", name: "Gold Receipt Reports", description: "Gold receipt reporting.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 8 }),
  f({ key: "reports.audit-trails", name: "Audit Trail Reports", description: "Audit trail reporting pages.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 6 }),
  f({ key: "reports.downtime-analytics", name: "Downtime Analytics", description: "Downtime analysis reports.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 8 }),
  f({ key: "reports.compliance-incidents", name: "Compliance Incidents Reports", description: "Compliance incident reports.", domain: "reports", defaultEnabled: false, isBillable: true, monthlyPrice: 8 }),
  ...
  f({ key: "admin.payroll-config", name: "Payroll Configuration", description: "Payroll configuration endpoints.", domain: "admin", defaultEnabled: false, isBillable: true, monthlyPrice: 6 }),
