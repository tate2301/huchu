 ...
 *     `(format: TableExportFormat) => void | Promise<void>` explicitly, so
...
const defaultFormats: TableExportFormat[] = ["pdf", "csv"];
  ...
  return (
    <DsExportMenu
      ...
      onExport={(id) => {
        ...
        // back to `TableExportFormat` for the caller's callback.
