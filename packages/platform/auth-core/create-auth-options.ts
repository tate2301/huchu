...
import { getAdminPortalHost, isAdminPortalHost } from "../admin-portal";
...
import { registeredPortalByPrefix } from "../manifest";
...
import { normalizeCallbackUrl } from "./redirects";
import { assertStrategyEnabled } from "./strategy-registry";
import type {
  AuthStrategyId,
    ...
    providers: [
      ...
      CredentialsProvider({
        ...
        async authorize(credentials, req) {
          ...
          // A portal host admits the roles its module says it does (`signInRoles`
