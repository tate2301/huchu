...
// The binary may be linked into this app's node_modules or sit only in the
// pnpm store at the workspace root, and the process may be started from either
// directory. Every ancestor of both is searched, nearest first.
function findSparticuzBinDirectories(): string[] {
  ...
  for (const root of roots) {
    const direct = join(root, "node_modules", "@sparticuz", "chromium", "bin");
