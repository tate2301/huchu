...
import { startPeriodicHealthCheck, stopPeriodicHealthCheck } from "./error-handler";
...
function defaultConnectivityCheck(): { isOnline: boolean; quality: string } {
  ...
  try {
    const { getCurrentConnectivityState } = require("./connectivity");
