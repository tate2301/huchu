import { OFFLINE_DB_STORES, getOfflineRecord, putOfflineRecord } from "./db";
import { emitOfflineBootstrapChanged } from "./events";
import { buildTenantScopedBootstrapId } from "./tenant-context";
import type {
