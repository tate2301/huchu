...
import { ApiKeysPanel } from "./settings/api-keys-panel";
import { CommissionsPanel } from "./settings/commissions-panel";
import { CustomFieldsPanel } from "./settings/custom-fields-panel";
import { LeadSourcesPanel } from "./settings/lead-sources-panel";
import { PipelinesPanel } from "./settings/pipelines-panel";
