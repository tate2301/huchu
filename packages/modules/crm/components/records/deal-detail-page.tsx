...
import { daysSince, dealStageStatus, resolveNextStep } from "../../tones";
import { fetchCrmFieldDefinitions, type CrmFieldDefinitionRecord } from "../../crm-v2";
...
import type { LeadDocument } from "../documents/document-types";
import {
  automationTab,
  historyTab,
  paperworkTab,
...
import { CONTACT_ACTIVITY_KIND } from "./event-kind";
import { RecordStory } from "./record-story";
import { buildStory } from "../../story";
import { VisitsTab } from "../lead-detail/visits-tab";
import type { LeadActivity, LeadAppointment, LeadFollowUp } from "../lead-detail/lead-types";
...
import { useJobsTab } from "../work-orders/jobs-tab";
