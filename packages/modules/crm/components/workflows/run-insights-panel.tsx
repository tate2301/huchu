...
import { formatRate, type ReportRange } from "../../reports";
import { formatDuration, type FailureGroup, type RulePerformance, type RunTotals } from "../../run-insights";
import { RecordList } from "@corelithzw/module-records/components/record-list";
