...
import { fetchGoldPurchases } from "../../../../api-client";
    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <NumericCell align="left">
            <ClientDate value={row.original.purchaseDate} />
          </NumericCell>
        ),
        size: 128,
        minSize: 128,
      ...
      },
      {
        ...
        header: "Batch ID",
        cell: ({ row }) => (
          <span className="font-mono">{row.original.goldPour.pourBarId}</span>
        ),
        size: 112,
        minSize: 112,
        maxSize: 112,
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <Badge
            variant={
              row.original.sellerType === "EMPLOYEE" ? "info" : "secondary"
            }
          >
      ...
      >
        <SheetContent size="xl" className="w-full p-6">
          <SheetHeader>
            ...
            <SheetDescription>
              Capture seller details, custody intake, and payment for
              company-owned gold.
            </SheetDescription>
          </SheetHeader>
          <div className="mt-6">
