/**
 * The till's registers and their books: which site and register a sale is
 * rung on, that the location and the item belong to the tenant, and how a
 * sale's payments post to the ledger. Pure of any request: the routes wrap
 * these with their session and their error shapes.
 */
