...
import { getRetailPosPolicy, RETAIL_POS_POLICY_PROVIDER_KEY } from "./pos-policy";
import { getRetailSetupProfile, RETAIL_SETUP_PROFILE_PROVIDER_KEY } from "./setup-profile";
