...
import { ACCOUNTING_CATEGORIES, ACCOUNTING_TABS, type AccountingTab } from "../tab-config";
import { filterAccountingTabsByFeatures } from "../visibility";
import { getWorkspaceModulePresentation } from "@corelithzw/platform/workspace-products";

export type { AccountingTab } from "../tab-config";
