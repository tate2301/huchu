...
vi.mock("../../../../fiscal-day", async () => {
  const actual = await vi.importActual<typeof import("../../../../fiscal-day")>(
    "../../../../fiscal-day",
  );
  return { ...actual, openFiscalDay: openFiscalDayMock };
});

import { FiscalDayAlreadyOpenError, FiscalDayConfigError } from "../../../../fiscal-day";
