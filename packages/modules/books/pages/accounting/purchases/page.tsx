...
import { AccountingLineItemsListView } from "../../../components/listview/accounting-line-items-list-view";
...
import { type AgingRow, type BankAccountRecord, type DebitNoteRecord, type PurchaseBillRecord, type PurchasePaymentRecord, type PurchaseWriteOffRecord, type StatementLineRecord, type VendorRecord, fetchApAging, fetchBankAccounts, fetchDebitNotes, fetchPurchaseBills, fetchPurchasePayments, fetchPurchaseWriteOffs, fetchTaxCodes, fetchVendorStatement, fetchVendors } from "../../../api-client";
...
export default function AccountingPurchasesPage() {
  ...
  useEffect(() => {
    ...
    const frameId = window.requestAnimationFrame(() => {
      ...
      } else if (action === "new-debit-note") {
        setActiveView("debit-notes");
