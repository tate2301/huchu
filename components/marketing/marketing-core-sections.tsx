    ...
    <>
      <section id="product" className="mx-auto max-w-7xl px-6 pb-20 pt-10 lg:px-8 lg:pb-28">
        ...
        <div className="mt-14">
          ...
          <StaggerChildren staggerDelay={0.1} className="grid gap-4 lg:grid-cols-3">
      ...
      <section id="solutions" className="mx-auto max-w-7xl px-6 pb-20 lg:px-8 lg:pb-28">
        <div className="grid gap-10 lg:grid-cols-[0.76fr_1.24fr] lg:items-end">
          ...
          <div className={`${styles.bentoGrid} ${styles.bentoGrid2}`}>
            {showcaseCards.map((card, index) => (
              <Reveal
                key={card.eyebrow}
                delay={index * 0.1}
                className={`${styles.productShowcaseCard} ${index === 2 ? styles.bentoWide : ""}`}
              >
                <p className={styles.productFeatureEyebrow}>{card.eyebrow}</p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 lg:px-8 lg:pb-28">
        <div className="grid gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-start">
          ...
          <StaggerChildren staggerDelay={0.1} className="grid gap-5 md:grid-cols-2">
            {valuePillars.map((pillar) => {
              const Icon = pillar.icon;
              return (
                <StaggerItem key={pillar.title}>
                  <div className={styles.productValueCard}>
