...
const sheetVariants = cva(
  "fixed z-50 gap-4 max-h-[100dvh] overflow-y-auto overscroll-contain bg-popover shadow-[var(--elevation-3)] transition ease-[var(--motion-ease-standard)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
